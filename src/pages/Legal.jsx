  ...
  return (
    <main className="max-w-6xl mx-auto px-6 md:px-12 py-24 space-y-16">
      ...
      <section className="grid lg:grid-cols-2 gap-8 animate-reveal">
        <div className="bg-white border border-slate-200 p-10 md:p-12 rounded-[2.5rem] space-y-8 shadow-sm hover:shadow-xl transition-all h-full">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-xl font-black text-slate-900 leading-tight">Naturaleza Jurídica</p>
            </div>
          </div>
          <ul className="space-y-5">
            {[
              ...
              <li key={idx} className="flex items-start gap-4 text-slate-600 font-medium text-base leading-snug">
                <div className="w-2 h-2 rounded-full bg-emerald-500 mt-1.5 shadow-sm shadow-emerald-500/40" />
                {item}
              </li>
            ))}
          </ul>
        ...
        <div className="bg-slate-900 text-white p-10 md:p-12 rounded-[2.5rem] space-y-8 shadow-xl relative overflow-hidden group h-full">
          ...
          <div className="flex items-center gap-5 relative z-10">
            ...
            <div>
              <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1.5">Estructura de Capital</h4>
          ...
          <div className="space-y-5 relative z-10">
            <div className="bg-white/5 p-6 rounded-2xl border border-white/10 flex justify-between items-center group-hover:bg-white/10 transition-all">
              ...
              <span className="text-2xl font-black text-emerald-400 leading-none">$100.000.000</span>
            </div>
            <div className="bg-emerald-500/10 p-6 rounded-2xl border border-emerald-500/30 flex justify-between items-center transform md:scale-105 shadow-md">
              <span className="text-emerald-100 font-bold uppercase text-[10px] tracking-widest">Aporte por Socio</span>
